...
select_sorted(sort_columns="high", limit=2, group_by_name=False, order='desc', filename='dump4.csv')

select_sorted(sort_columns="low", limit=1, group_by_name=False, order='desc', filename='dump5.csv')

select_sorted(sort_columns="high", limit=2, group_by_name=False, order='desc', filename='dump6.csv')
